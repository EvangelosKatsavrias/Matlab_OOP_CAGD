...
if nargin > 2; fieldNames = varargin{2}; else fieldNames = fieldnames(obj.SignalSlots.ControlPoints); end
...
for fieldIndex = 1:length(fieldNames)
    obj.SignalSlots.ControlPoints.(fieldNames{fieldIndex}).Enabled = setValue;
end

obj.SignalSlots.BasisFunctions.tensorBasisFunctionsChanged.Enabled = setValue;
